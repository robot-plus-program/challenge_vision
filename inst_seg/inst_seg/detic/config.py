...
def add_detic_config(cfg, path):
    ...
    _C.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_PATH = f'{path}/datasets/metadata/lvis_v1_clip_a+cname.npy'
    ...
    _C.MODEL.ROI_BOX_HEAD.CAT_FREQ_PATH = \
        f'{path}/datasets/metadata/lvis_v1_train_cat_info.json'
    ...
    _C.DATALOADER.TARFILE_PATH = f'{path}/datasets/imagenet/metadata-22k/tar_files.npy'
    _C.DATALOADER.TAR_INDEX_DIR = f'{path}/datasets/imagenet/metadata-22k/tarindex_npy'
    ...
    _C.SAVE_DEBUG_PATH = f'{path}/output/save_debug/'